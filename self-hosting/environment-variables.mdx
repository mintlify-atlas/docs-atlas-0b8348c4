...
|----------|---------|-------------|
| `WORMKEY_CONTROL_PLANE_URL` | `http://localhost:3001` | Control plane API endpoint for session creation |
| `WORMKEY_EDGE_URL` | `ws://localhost:3002/tunnel` | Gateway WebSocket endpoint for tunnel connections |
